  ...
  return (  
    <nav className='p-4'>
      <div className='container mx-auto flex justify-between items-center'>
        <Link to={'/'} className='flex gap-x-1 items-center cursor-pointer'>
        ...
        <div className={`md:static absolute  left-0 p-4 w-full md:w-auto md:p-0 transition-all duration-300 ease-in md:opacity-100  ${isMenuOpen ? 'top-[50px] opacity-100' : 'top-[-300px] opacity-0'}`}>
          <ul className='flex gap-x-3 md:flex-row items-center md:gap-3'>
            <li>
              <Link to={'/create'}>
                <i className='px-2 py-1 border rounded-md dark:border-[#80A2A6] dark:hover:bg-[#F2F2F2] dark:hover:border-[#F2F2F2] border-[#40a8d8]  hover:bg-[#d5f2ff] hover:border-[#9bdfff] transition duration-300 cursor-pointer'><i className="fa-regular fa-square-plus fa-lg" style={{color: `${isDarkmode ? '#80A2A6' : '#40a8d8'}`}}></i></i>
              </Link>
            </li>  
            <li>
